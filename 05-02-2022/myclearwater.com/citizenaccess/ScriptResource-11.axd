...
AccelaWebControlExtender.HelperBehavior.prototype = {
    ...
    initialize: function () {
        ...
        this._bg_ml = 'url(WebResource.axd?d=Ll2drMghLoKZk2_86DqPsyDofXCpcPqd9HfZIH750oS5irnNW2JG4NGf2-R4oUEZdF7Z4-DfHT0Zmy2uo_er455BgmF-SeJZl-yaOisRAQ_0DRFBGu6AF8DmfiQuu2dLo9N1LWhiRUnsGmwJmDaSObpjLjT9WDNSxZ_eqINpjvs1&t=637787957340000000) repeat-y'; //cell's background image: middle left
        this._bg_mr = 'url(WebResource.axd?d=xeNM_hcNRuhZm4wHhsAozUKO70wWzO89Jd3YRyXxZe2LTqoxH0274jZheYrJpwKvwwvjdCVhIPVFBOY4AbgbDYGC-ujwwdgSC3ytC4YeB800dkmbKGv_r5kaf8yGS3scBkP1rFpKeKtxlrxT32vD4jwp94mQnFNdKrmfk8OEDtA1&t=637787957340000000) repeat-y'; //cell's background image: middle right
        this._bg_pl = 'url(WebResource.axd?d=spwWW6rH4-VJ0zO41-qxYBd57G4MASYpWnFms8aj_2PQQaDll2qrGXggcVHoVLNSjInOiUtSegD37hDG6-03Z130lcij1oi3UOXwWoVZFlXpcN21KrN7ARF7f5uY_4-v4M2Bsinr8cfLOgMAzDLqvRueFWZv-wev67xbiHMLF0M1&t=637787957340000000) no-repeat'; //cell's background image: left pointer
        this._bg_pr = 'url(WebResource.axd?d=SjoJYYeYkbJ-UtmmqOm4z63RJ1rd3zJVLZpH3ObVTQ3JgrZ1hoKogs4GNRfw8y09Mnx3srLQA7Xu189hB5zrZYalXl0DRBmWBlWz5MjB1chY7pEQYeVsP4qpm0qJjxp12q-zcnlz5eAA-hGN2SAdxoHtedbvy5xTRM34Weya8L01&t=637787957340000000) no-repeat'; //cell's background image: right pointer
    ...
    create: function () {
        ...
        result.innerHTML +=
            '<a id="btnHelpClose" href="javascript:void(0);" onclick = "return false;" class="closebutton NotShowLoading" title="' + this._closeTitle + '"><img src="WebResource.axd?d=SOValPgCWKI_PS47zHiHdgl2-V2EICywsK-mmJT6jU7g2l79hMu5LmcyuYr4Q_hH-1YJN1_cZbTSY3jdUtCkbzNzRj2UWzBLV7A4-octHZK9USorCCQQ_BEhOEMey6huFKLzHrDKc5A6d-DX8-cc1Rf3szRi83mW5Js9MVx7elA1&t=637787957340000000" alt="' + this._closeTitle + '" /></a>' +
