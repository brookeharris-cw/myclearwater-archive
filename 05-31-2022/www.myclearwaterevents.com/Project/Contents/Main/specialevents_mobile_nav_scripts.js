...
$(document).ready(function () {
    ...
    $(".search-trigger").appendTo($(".mainnav"));
    ...
    $('.search_container, .search-trigger, .chromeperfectpixel-panel-container, .chromeperfectpixel-portal, .chromeperfectpixel-overlay').click(function (event) {
    ...
    /* $(window).scroll(function () {
        if ($(window).width() < 768) {
            var pos_nav = $(".nav-tabs").position();
            pos_nav = pos_nav.top;
            if ($("body").scrollTop() >=  260) {
                $(".nav-tabs").addClass("nav-fixed");
            }else{
                $(".nav-tabs").removeClass("nav-fixed");
            }
        }else{
            $(".nav-tabs").removeClass("nav-fixed");
        }
